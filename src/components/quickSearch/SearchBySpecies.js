					...
					<div className="quick-search">
						<ExpansionPanel id={quickSearch.question_8.id} defaultExpanded={props.questionId === quickSearch.question_8.id}>
							...
							<Grid container xs={12} sm={12}>
								<Grid item xs={12} sm={12}>
									<TextAlert alertInput={props.alertText.question === quickSearch.question_8.id ? props.alertText.input : props.alertText.default} />
								</Grid>
								<Grid item xs={12} sm={6} className="quick-search-control">
									<FormControl fullWidth variant='outlined'>
										...
										<SelectControl
											...
											placeholder={searchBySpecies.common.organism.placeholder}
											placeholderId={searchBySpecies.common.organism.placeholderId}
											placeholderName={searchBySpecies.common.organism.placeholderName}
											menu={props.glycanInitData.organism ? props.glycanInitData.organism.map((type) => {return {id: type.id, name: type.name}}): props.glycanInitData.organism}
											setInputValue={(input)=> props.setInputValue({question_8: input})}
										/>
									</FormControl>
								</Grid>
						...
						<ExpansionPanel id={quickSearch.question_9.id} defaultExpanded={props.questionId === quickSearch.question_9.id}>
							...
							<ExpansionPanelDetails>
								<Grid container xs={12} sm={12}>
									<Grid item xs={12} sm={12}>
										<TextAlert alertInput={props.alertText.question === quickSearch.question_9.id ? props.alertText.input : props.alertText.default} />
									</Grid>
									<Grid item xs={12} sm={6} className="quick-search-control">
										<FormControl fullWidth variant='outlined'>
											<Typography
											...
											<SelectControl
												...
												placeholderName={searchBySpecies.common.organism.placeholderName}
												menu={props.glycanInitData.organism ? props.glycanInitData.organism.map((type) => {return {id: type.id, name: type.name}}): props.glycanInitData.organism}
												setInputValue={(input)=> props.setInputValue({question_9: input})}
											/>
										</FormControl>
									</Grid>
									<Grid item xs={12} sm={2} className="quick-search-control">
						...
						<ExpansionPanel id={quickSearch.question_10.id} defaultExpanded={props.questionId === quickSearch.question_10.id}>
							...
							<Grid container xs={12} sm={12}>
								<Grid item xs={12} sm={12}>
									<TextAlert alertInput={props.alertText.question === quickSearch.question_10.id ? props.alertText.input : props.alertText.default} />
								</Grid>
								<Grid item xs={12} sm={6} className="quick-search-control">
									<FormControl fullWidth variant='outlined'>
										<Typography
										...
										<SelectControl
											...
											placeholderName={searchBySpecies.common.organism.placeholderName}
											menu={props.glycanInitData.organism ? props.glycanInitData.organism.map((type) => {return {id: type.id, name: type.name}}): props.glycanInitData.organism}
											setInputValue={(input)=> props.setInputValue({question_10: {organism: input, glycosylation_evidence: props.inputValue.question_10.glycosylation_evidence}})}
										/>
									</FormControl>
								</Grid>
								<Grid item xs={12} sm={3} className="quick-search-control">
									<FormControl fullWidth variant='outlined'>
										...
										<SelectControl
											...
											setInputValue={(input)=> props.setInputValue({question_10: {organism: props.inputValue.question_10.organism, glycosylation_evidence: input}})}
										/>
									</FormControl>
								</Grid>
									<Grid item xs={12} sm={2} className="quick-search-control">
										...
										<Button
											...
											disabled={props.inputValue.question_10.glycosylation_evidence === ""}
										>
											Search
										</Button>
									</Grid>
