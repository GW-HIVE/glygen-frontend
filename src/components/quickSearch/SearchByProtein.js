				...
				<section className="content-box-sm" style={{ margin: "0 auto" }}>
					...
					<div className="quick-search">
						<ExpansionPanel id={quickSearch.question_4.id} defaultExpanded={props.questionId === quickSearch.question_4.id}>
							...
							<Grid container xs={12} sm={12}>
								<Grid item xs={12} sm={12}>
									<TextAlert alertInput={props.alertText.question === quickSearch.question_4.id ? props.alertText.input : props.alertText.default} />
								</Grid>
								...
								<FormControl fullWidth variant='outlined'>
									...
									<AutoTextInput
										...
										setInputValue={(input)=> props.setInputValue({question_4: input})}
						...
						<ExpansionPanel id={quickSearch.question_5.id} defaultExpanded={props.questionId === quickSearch.question_5.id}>
							...
							<Grid container xs={12} sm={12}>
								<Grid item xs={12} sm={12}>
									<TextAlert alertInput={props.alertText.question === quickSearch.question_5.id ? props.alertText.input : props.alertText.default} />
								</Grid>
								<Grid item xs={12} sm={6} className="quick-search-control">
								<FormControl fullWidth variant='outlined'>
									<Typography className="qs-search-lbl" gutterBottom>
									...
									<AutoTextInput
										...
										setInputValue={(input)=> props.setInputValue({question_5: input})}
										placeholder={searchByProtein.common.placeholder}
										typeahedID={searchByProtein.common.typeahedID}
										length={searchByProtein.common.length}
										errorText={searchByProtein.common.errorText}
						...
						<ExpansionPanel id={quickSearch.question_6.id} defaultExpanded={props.questionId === quickSearch.question_6.id}>
							...
							<Grid container xs={12} sm={12}>
								<Grid item xs={12} sm={12}>
									<TextAlert alertInput={props.alertText.question === quickSearch.question_6.id ? props.alertText.input : props.alertText.default} />
								</Grid>
								<Grid item xs={12} sm={6} className="quick-search-control">
								<FormControl fullWidth variant='outlined'>
									<Typography className="qs-search-lbl" gutterBottom>
									...
									<AutoTextInput
										...
										setInputValue={(input)=> props.setInputValue({question_6: input})}
										placeholder={searchByProtein.common.placeholder}
										typeahedID={searchByProtein.common.typeahedID}
										length={searchByProtein.common.length}
										errorText={searchByProtein.common.errorText}
							...
							<Grid container xs={12} sm={12}>
								...
								<FormControl fullWidth variant='outlined'>
									...
									<AutoTextInput
										...
										setInputValue={(input)=> props.setInputValue({question_7: input})}
										placeholder={searchByProtein.common.placeholder}
										typeahedID={searchByProtein.common.typeahedID}
										length={searchByProtein.common.length}
										errorText={searchByProtein.common.errorText}
