					...
					<div className="quick-search">
						<ExpansionPanel>
							<ExpansionPanelSummary
								...
								<Typography className="gg-blue-color">
									{quickSearchData.quickSearch.searchByProtein.question_1.text}
								</Typography>
							</ExpansionPanelSummary>
						...
						<ExpansionPanel>
							<ExpansionPanelSummary
								...
								id="panel2bh-header">
								<Typography className="gg-blue-color">
									{quickSearchData.quickSearch.searchByProtein.question_2.text}
								</Typography>
							</ExpansionPanelSummary>
							<ExpansionPanelDetails>
								<Typography>
						...
						<ExpansionPanel>
							<ExpansionPanelSummary
								...
								id="panel3bh-header">
								<Typography className="gg-blue-color">
									{quickSearchData.quickSearch.searchByProtein.question_3.text}
								</Typography>
							</ExpansionPanelSummary>
							<ExpansionPanelDetails>
								<Typography>
						...
						<ExpansionPanel>
							<ExpansionPanelSummary
								...
								id="panel1bh-header">
								<Typography className="gg-blue-color">
									{quickSearchData.quickSearch.searchByProtein.question_4.text}
								</Typography>
							</ExpansionPanelSummary>
							<ExpansionPanelDetails>
								<Typography>
