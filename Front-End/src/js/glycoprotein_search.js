...
// }
//
// /** functions for sortdropdown compare names
...
//
//
// /** functions for createOption to create
//  * dropdown option
//  * * @param {text, value}
//  * @returns {option}dropdown
//  */
...
//
//     if (organism.id !== "0") {
//         organisms.id = organism.id;
//         organisms.name = organism.name;
//     }
//     var formObject = {
//         operation: "AND",
...
//     $.ajax({
//         type: 'post',
//         url: getWsUrl("search_protein"),//calling search_protein f from ws_url
//         data: json,
//         timeout: getTimeout("search_protein"), //calling timeout f from utility
