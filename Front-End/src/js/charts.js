...
function vennProteinSpecies(dummy, data, id) {
  ...
  switch (getParameterByName("vennProtType")) {
      case "Homo sapiens":
        proteinType = data.venn_protein_homo;
        ddlValue = "human";
        break;
      case "Mus musculus":
        proteinType = data.venn_protein_mus;
        ddlValue = "mouse";
        break;
      case "Rattus norvegicus":
        proteinType = data.venn_protein_rat;
        ddlValue = "rat";
        break;
      default:
        proteinType = data.venn_protein_homo;
  ...
  div_protein_homo.datum(proteinType)
    .call(protein_homo);
  $('#vennProteinSpecies').val(ddlValue);
  $('#label_text').text(updateLabel(ddlValue));
